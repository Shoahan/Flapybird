...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midbottom=(300, random_pipe_pos - 180))
...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = high_score_surface.get_rect(center=(144, 440))
...
#screen.title("Pysnakegame by @shohan")
...
bird_midfalp = pygame.image.load('assets/bluebird-midflap.png').convert_alpha()
bird_upflap = pygame.image.load('assets/bluebird-upflap.png').convert_alpha()
bird_frames = [bird_downflap,bird_midfalp,bird_upflap]
bird_index = 0
